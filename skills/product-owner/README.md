...
- [User Story Mapping](https://userstorymapping.com/)

## Related Skills

- **`scrum-master`** - For facilitating Agile ceremonies
- **`testing-strategy`** - For testing and quality assurance
- **`architecture-patterns`** - For technical requirements gathering
